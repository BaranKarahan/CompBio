...
sequences, names = fastareader("sequences_1000_v3.fas")
...
print(problem_seq[:5]) #found only 1 sequence where this value is significantly big. because there is only 1, I left it in
print(seq_len)
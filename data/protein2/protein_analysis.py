...
print(problem_seq[:10]) #found 5 sequences where this value is bigger than or equal to 39. I concluded that printing 10 of the biggest would show the result.

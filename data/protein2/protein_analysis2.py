...
print(problem_seq[:10]) #found 4 sequences where this value is bigger than or equal to 40. I concluded that printing 10 of the biggest would show the result.
...
out = open('new_protein_1000v2.fasta', 'w')
